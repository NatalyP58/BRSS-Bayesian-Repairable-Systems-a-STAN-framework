...
# Date: April 15, 2026
# ------------------------------------------------------------
# File: ARA frequentist estimation
# ------------------------------------------------------------
# This file provides a frequentist estimator for the Arithmetic
# Reduction of Age (ARA) model using numerical maximization of
...
# ------------------------------------------------------------
# Frequentist estimation for the ARA model
# ------------------------------------------------------------
frequentist_estimation <- function(time, time_trunc) {
  
  # Numerical maximization of the ARA log-likelihood
  result <- try(
    optimx::optimr(
      par = c(1.1, 1.1, 0.1),           # initial values for (beta, mu_T, theta)
      fn = log_like_ARA,              # ARA log-likelihood to be maximized
      ...
      lower = c(1, 0, -1),             # lower bounds for (beta, mu_T, theta)
