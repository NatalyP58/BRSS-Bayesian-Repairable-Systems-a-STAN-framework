...
# Date: April 15, 2026
# ------------------------------------------------------------
# File: ARAM Bayesian estimation with dependent priors
# ------------------------------------------------------------
# This file implements Bayesian estimation for the Arithmetic
# Reduction of Age with Memory (ARAM) model using Stan under a
...
# ------------------------------------------------------------
# Bayesian estimation for the ARAM model with dependent priors
# ------------------------------------------------------------
