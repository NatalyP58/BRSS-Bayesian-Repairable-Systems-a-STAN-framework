# Simulation Module for the Arithmetic Reduction of Age with Memory (ARAM)

This folder contains the simulation workflow for the **Arithmetic Reduction of Age with Memory (ARAM)** model developed in the manuscript:
...
- `aram_simulation_cluster.R`  
- `aram_simulation_results.R`  
...
3. store outputs,  
4. summarize performance using bias, mean squared error (MSE), and empirical coverage.  

---

## 1. `aram_simulation_cluster.R`
...
- generates failure-time data under the ARAM model,  
- fits the ARAM model using three estimation methods,  
