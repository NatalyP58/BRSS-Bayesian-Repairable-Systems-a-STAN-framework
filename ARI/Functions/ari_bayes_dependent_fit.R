...
# Date: April 15, 2026
# ------------------------------------------------------------
# File: ARI Bayesian estimation with dependent priors
# ------------------------------------------------------------
# This file implements Bayesian estimation for the Arithmetic
# Reduction of Intensity (ARI) model using Stan under a
...
# ------------------------------------------------------------
# Bayesian estimation for the ARI model with dependent priors
# ------------------------------------------------------------
bayesian_estimation_dep <- function(time, time_trunc, beta_r = NULL, mu_T_r = NULL,
                                    rho_r = NULL, compiled_model = NULL,
  ...
  init_fun  <- function() { list(beta  = 1.1, mu_T  = 1.1, rho = 0.1 )}
