# Simulation Module for the Arithmetic Reduction of Intensity (ARI)

This folder contains the simulation workflow for the **Arithmetic Reduction of Intensity (ARI)** model developed in the manuscript:
...
- `ari_simulation_cluster.R`
- `ari_simulation_results.R`
...
- generates failure-time data under the ARI model,
- fits the ARI model using three estimation methods,
