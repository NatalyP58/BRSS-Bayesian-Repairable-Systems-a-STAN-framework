# Simulation Module for the Power Law Process (PLP)

This folder contains the simulation workflow for the **Power Law Process (PLP)** model developed in the manuscript:
...
- `plp_simulation_cluster.R`
- `plp_simulation_results.R`
...
- generates failure-time data under the PLP model,
- fits the PLP model using three estimation methods,
