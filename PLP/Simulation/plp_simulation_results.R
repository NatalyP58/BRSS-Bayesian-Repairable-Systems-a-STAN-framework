...
# Date: April 15, 2026
# ------------------------------------------------------------
# File: PLP simulation results summary
# ------------------------------------------------------------
# This script summarizes simulation results for the PLP model.
# It computes bias, mean squared error (MSE), and empirical
# coverage for the frequentist estimator and the two Bayesian
# estimators:
...
sim_df_coverage <- function(sim) {
  ...
  colnames(simul) <- c("Method", "HPD_beta", "HPD_mu_T")
  return(simul)
}
