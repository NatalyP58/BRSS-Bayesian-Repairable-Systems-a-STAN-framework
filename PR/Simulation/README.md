# Simulation Module for the Perfect Repair (PR) Model

This folder contains the simulation workflow for the **Perfect Repair (PR)** model developed in the manuscript:
...
- `pr_simulation_cluster.R`
- `pr_simulation_results.R`
...
- generates failure-time data under the PR model,
- fits the PR model using three estimation methods,
